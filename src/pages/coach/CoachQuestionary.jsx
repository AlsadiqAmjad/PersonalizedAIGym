    ...
    <div className="min-h-screen bg-background text-foreground p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <form
          ...
          className="bg-card rounded-lg shadow-lg p-6 border border-border flex flex-col gap-4"
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex flex-col">
              ...
              <input
                ...
                className="px-4 py-2 bg-muted text-foreground rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="e.g. 30"
                required
              />
            </div>
            ...
            <div className="flex flex-col">
              <label className="text-sm text-muted-foreground mb-1">Height (cm)</label>
              <input
                type="number"
                min="100"
                value={height}
            ...
            <div className="flex flex-col">
              <label className="text-sm text-muted-foreground mb-1">Weight (kg)</label>
              <input
                type="number"
                min="30"
                value={weight}
            ...
            <div className="flex flex-col">
              ...
              <select
                ...
                className="px-4 py-2 bg-muted text-foreground rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-blue-500"
                required>
